...
class ShopController {
    ...
    function list() {
        if(isset($_GET['id_dm'])){
            $id_dm = $_GET['id_dm'];
            $data_sp_dm = $this->shop_model->sp_dm($id_dm);
            $ten_dm = $this->shop_model->ten_dm($id_dm);
        }
        
        if(isset($_GET['id_lsp'])){
            $id_lsp = $_GET['id_lsp'];
            $data_sp_lsp = $this->shop_model->sp_lsp($id_lsp);
            $ten_lsp = $this->shop_model->ten_lsp($id_lsp);
        }


        $data_loaisanpham = $this->shop_model->loaisanpham();
