...
<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
    <form action="?mod=khuyenmai&act=update" method="POST" role="form" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="" placeholder="" name="GiaTri" value="<?= $data['GiaTri'] ?>">
        </div>
        <div class="form-group">
            <label for="">Ngày bắt đầu</label>
            <input type="text" class="form-control" id="" placeholder="" name="NgayBD" value="<?= $data['NgayBD'] ?>">
        </div>
        <div class="form-group">
            <label for="">Ngày kết thúc</label>
            <input type="text" class="form-control" id="" placeholder="" name="NgayKT" value="<?= $data['NgayKT'] ?>">
        </div>
        <div class="form-group">
               <label for="">Trạng thái</label>
               <select id="" name="TrangThai" class="form-control">
                    <option <?= ($data['TrangThai'] == '0')?'selected':''?> value="0"> Không hiệu lực</option>
                    <option <?= ($data['TrangThai'] == '1')?'selected':''?> value="1"> Hiệu lực</option>
               </select>
           </div>
