...
if (isset($_SESSION['isLoginAdmin']) && $_SESSION['isLoginAdmin'] == true) {
    ...
    switch ($mod) {
        case 'nhanvien':
            require_once('MVC/controllers/NhanVienController.php');
            $controller_obj = new NhanVienController();
            switch ($act) { 
                case 'list':
                    $controller_obj->list();
                    break;
        ...
        case 'khachhang':
            require_once('MVC/controllers/KhachHangController.php');
            $controller_obj = new KhachHangController();
            switch ($act) {
                case 'list':
                    $controller_obj->list();
                    break;
        ...
        case 'banner':
            ...
            break;
        case 'taikhoan':
            require_once('MVC/controllers/TaiKhoanController.php');
            $controller_obj = new TaiKhoanController();
            switch ($act) {
                case 'list':
                    $controller_obj->list();
                    break;
    ...
    if (isset($_SESSION['isLoginShipper']) && $_SESSION['isLoginShipper'] == true) {
        $mod = isset($_GET['mod']) ? $_GET['mod'] : "login";
        $act = isset($_GET['act']) ? $_GET['act'] : "admin";
        switch ($mod) {
            case 'loaisanpham':
